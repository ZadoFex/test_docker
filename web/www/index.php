...
<html lang="it">
  <head>
    ...
    <link rel="stylesheet" href="assets/css/main.css?ver=<?php echo $VERSION; ?>" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
  ...
  <body>
    <h1 class="w100">Hello, world!</h1>
    <h1 style="font-family: 'Montserrat'; ">Hello, world!</h1>
    <p class="w400">casd sad asm das  dsa</p>
    <!-- Optional JavaScript -->
